class ApiCallLogsController < ApplicationController
  ...
  private
    ...
    def api_call_log_params
      params.require(:api_call_log).permit(:call_description, :call_date_time, :successful, :end_point_path, :twitter_handle, :records_inserted)
    end
end
